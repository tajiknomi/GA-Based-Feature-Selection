...
% Extract the features for the images & save those features in "feature_set"
...
feature_set(read_image_count,:) = [(Mean_Feature_Matrix)',(Range_Feature_Matrix)',(Variance_Feature_Matrix)'];

end

feature_names = {'Dissimilarity';'Homogeneity';'max_prob';'Shade';'Inertia';'diff_Entropy';'Sum_Entropy';'Sum_Average';'Variance';'Entropy';'IDM';'Contrast';'Energy';'dev_y';'dev_x';'mean_y';'mean_x'};
feature_names = [feature_names;feature_names;feature_names]';

% 8 feature out of 51 are selected by Genetic Algo...

%feature_set = [feature_set(:,6) feature_set(:,7) feature_set(:,9) feature_set(:,16) feature_set(:,30) feature_set(:,32) feature_set(:,43) feature_set(:,48)];

% 3 feature selected...
%feature_set = [feature_set(:,1) feature_set(:,4) feature_set(:,6)];